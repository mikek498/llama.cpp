...
// M1 Max ultra-optimized dot product (new 128-element implementation)
void m1_ultra_dot_product_128(int n, float* result, const float* x, const float* y) {
...
int main() {
    ...
    std::cout << "M1 Max Ultra-Optimized SIMD Benchmark\n";
    std::cout << "=====================================\n";
    std::cout << "Vector size: " << n << " elements\n";
    std::cout << "Iterations: " << iterations << "\n\n";
    
    // Test M1 Ultra 128-element implementation
    {
        float result = 0.0f;
        auto start = std::chrono::high_resolution_clock::now();
        
        for (int i = 0; i < iterations; ++i) {
            m1_ultra_dot_product_128(n, &result, x_aligned, y_aligned);
        }
        ...
        std::cout << "M1 Ultra 128-element unroll: " << mflops << " MFLOPS\n";
